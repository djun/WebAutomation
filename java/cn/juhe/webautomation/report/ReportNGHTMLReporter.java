 ...
 * @parameter
 */
public class ReportNGHTMLReporter extends HTMLReporter implements ITestListener {
	/**
	 * LogHandle
	 */
	...
	protected void reportLogScreenshot(File file) {
		...
		Reporter.log("<a href=\"" + absolute + "\"><p align=\"left\">Error screenshot at " + new Date() + "</p>");
		Reporter.log("<p><img width=\"1024\" src=\"" + absolute + "\" alt=\"screenshot at " + new Date()
				+ "\"/></p></a><br />");
	}
